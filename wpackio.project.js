...
module.exports = {
	// Project Identity
	appName: 'automate', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'automate', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	...
	files: [
		...
		},
		{
			...
			entry: {
				...
				// global namespace pollutions 😉
				// vendor: './src/mobile/vendor.js', // Could be a string
				main: ['./src/styles/sass/_main.scss'], // Or an array of string (string[])
			},
			// Extra webpack config to be passed directly
			webpackConfig: undefined,
